# mathematically the action of using a rule into a graph is called: 
################## derivation graph
import mod
from mod import *
...
# Set the database so you can work
...
with dg.build() as b:
    b.execute(
            ...
            #>> ketoEnol
            #>>enolKeto
            # since we have our rules in inputRules lets use it (to save lines)
            >>inputRules
            # you can also repeat rules
            >> repeat[2](inputRules)
